...
$('#top-matchup').sheetrock({
      url: mySpreadsheet,
      query: "select A,B,I,J,K,Z,AA,AB,AC,AD,AE,AF,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AT,AU,AV,BK,BL,BM,BN,BO,BP,BQ,BR,BS,BT,BU,BV,BW,BJ,CE,BZ,CA,CB,CC,CD where A = " + i + " and B = 1",
