...
$('#top-matchup').sheetrock({
      url: mySpreadsheet,
      query: "select A,B,I,J,K,Z,AA,AB,AC,AD,AE,AF,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AP,AQ,AR,AS,AT,AU,AV,AW,AX,AY,AZ,BA,BB,BQ,BR,BS,BT,BU,BV,BW,BX,BY,BZ,CA,CH,CI,CJ where A = " + i + " and B = 1",
